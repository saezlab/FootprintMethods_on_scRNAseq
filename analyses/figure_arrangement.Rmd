...
ggsave("~/Google Drive/Paper/scRNA_benchmark/RevisionGenBio/Figures/Fig1_general_robustness.png",
       general_robustness_main,
       width=10, height=5)
```
...
ggsave("paper/figures/supp_general_robustness1.png", 
       general_robustness_supp1,
       width = 12, height = 12)

ggsave("~/Google Drive/Paper/scRNA_benchmark/RevisionGenBio/Figures/FigS1_general_robustness.png",
       general_robustness_supp1,
       width=12, height=12)
```
#### Supp2
...
general_robustness_supp2 = plot_grid(p_gene_coverage_vs_auroc, g_gene_coverage_vs_auroc, p_auroc_vs_auprc, g_auroc_vs_auprc, labels = c("A", "C", "B", "D"), label_size = 18, align = "hv", axis = "lt")

ggsave("paper/figures/supp_general_robustness2.png", 
...
ggsave("paper/figures/main_in_silico_benchmark.png", 
       ...
       width = 15, height = 15)
ggsave("~/Google Drive/Paper/scRNA_benchmark/RevisionGenBio/Figures/Fig2_in_silico_benchmark.png",
       in_silico_benchmark_main,
       width=15, height=15)
```
...
ggsave("~/Google Drive/Paper/scRNA_benchmark/RevisionGenBio/Figures/FigS2_in_silico_benchmark_1.png",
       in_silico_benchmark_supp_1,
       width=10, height=5)
```
...
ggsave("~/Google Drive/Paper/scRNA_benchmark/RevisionGenBio/Figures/FigS3_in_silico_benchmark_2.png",
       in_silico_benchmark_supp_2,
       width=10, height=15)
```
...
ggsave("~/Google Drive/Paper/scRNA_benchmark/RevisionGenBio/Figures/FigS4_in_silico_benchmark_3.png",
       in_silico_benchmark_supp_3,
       width=15, height=10)
```
#### Supp4
...
ggsave("~/Google Drive/Paper/scRNA_benchmark/RevisionGenBio/Figures/FigS5_in_silico_benchmark_4.png",
       in_silico_benchmark_supp_4,
       width=15, height=10)
```
...
ggsave("~/Google Drive/Paper/scRNA_benchmark/RevisionGenBio/Figures/FigS6_in_silico_benchmark_5.png",
       in_silico_benchmark_supp_5,
       width=15, height=10)
```
...
ggsave("~/Google Drive/Paper/scRNA_benchmark/RevisionGenBio/Figures/Fig3_in_vitro_benchmark.png",
...
ggsave("~/Google Drive/Paper/scRNA_benchmark/RevisionGenBio/Figures/FigS7_in_vitro_benchmark.png",
...
ggsave("~/Google Drive/Paper/scRNA_benchmark/RevisionGenBio/Figures/Fig4_clustering_analysis.png",
       clustering_analysis_main,
       width=14, height=18)
...
ggsave("~/Google Drive/Paper/scRNA_benchmark/RevisionGenBio/Figures/FigS8_clustering_analysis.png",
       clustering_analysis_supp_1,
       width=10, height=5)
...
ggsave("~/Google Drive/Paper/scRNA_benchmark/RevisionGenBio/Figures/FigS9_clustering_analysis.png",
       clustering_analysis_supp_2,
       width=10, height=12)
...
ggsave("~/Google Drive/Paper/scRNA_benchmark/RevisionGenBio/Figures/FigS10_clustering_analysis.png",
       clustering_analysis_supp_3,
       width=10, height=12)
```
...
ggsave("~/Google Drive/Paper/scRNA_benchmark/RevisionGenBio/Figures/FigS11_clustering_analysis.png",
       clustering_analysis_supp_4,
       width=10, height=15)
